<section class="logo-search">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
      <a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>public/images/Unitedlogothoitrang.png" alt=""></a>
      
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> 0325 888 888
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> trantienanh1998@gmail.com
        </div>
      </div>
       ...
       <div class="cart_header">
        <a href="gio-hang" title="Giỏ hàng">
         <span class="cart_header_icon">
          <img src="<?php echo base_url() ?>public/images/logoXeday.png" alt="Cart">
        </span>
        <span class="box_text">
   ...
   <div class="user_login">
     <a href="thong-tin-khach-hang" title="Tài khoản">
      <div class="user_login_icon">
       <img src="<?php echo base_url() ?>public/images/logoDangnhap.png" alt="Cart">
     </div>
     <div class="box_text">
