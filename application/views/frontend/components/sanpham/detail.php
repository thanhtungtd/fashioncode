					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Tặng túi đựng hàng khi mua hàng</li>
											</ul>
											<ul>
												<li>Tặng kèm khẩu trang khi mùa hàng  <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
												<li>Giảm thêm 10% khi mua đơn hàng tổng trị giá từ 1,000,000 đ <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								...
								<span>Hàng nguyên seal, đầy đủ giấy tờ xuất xứ. Sản phẩm chính hãng, giá cả hợp lí</span>
							</div>
							<div style="margin-top: 20px;">
								<b>Bảo hành</b>
								<br>
								<span>Đổi trả hàng nếu không ứng ý</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
