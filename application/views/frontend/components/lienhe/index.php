			...
			<div class="section-article contactpage" style="  padding-left: 20px;">
				...
				<form accept-charset="UTF-8" action="<?php echo base_url() ?>lien-he" id="contact" method="post">
					...
					<div class="form-comment">
						...
						<button type="submit" class="btn-update-order" >Gửi</button>
		...
		<div class="col-md-4 col-12">
			...
			<ul class="list-unstyled">
				<li class="clearfix">
					...
					<span style="color: black"> Trường ĐH GTVT TP.HCM - Bình Thạnh</span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
					<span style="color: black">0325 888 888</span>
				</li>
				<li class="clearfix">
					<i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
					<span style="color: black"><a href="mailto:sale.24hstore@gmail.com">phamtung123@gmail.com</a></span>
				</li>
			</ul>
		</div>
