<section id="menu-slider">
    <div class="slider">
        <div class="container">
           ...
           <img style="width: 100%; height: 163px;" src="public/images/banner-Qc1.png">
             <img style="width: 100%; height: 163px;" src="public/images/banner-Qc2.png">
         </div>
...
<div class="container" style="margin-top: 20px;">
    <div class="sale-title">
        <span>SẢN PHẨM MỚI - ĐƯỢC QUAN TÂM</span>
    </div>
</div>
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #0f9ed8;">
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue">Tin tức thời trang</h2>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center m-b-xs-10">
                        <div class="service_item">
                            ...
                            <div class="description_icon">
                                ...
                                <span class="small-text">
                                    Sẽ được giao trong thời gian sớm nhất
                                </span>
                            </div>
                        </div>
                    </div>
