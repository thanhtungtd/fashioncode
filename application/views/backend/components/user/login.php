<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#337ab7">Shop thời trang</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2017 <a href="#" style="color:red">Shop thời trang</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
