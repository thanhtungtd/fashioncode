...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='Fashion_Shop-Giỏ hàng';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='Fashion_Shop - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $this->email->to($list);
            $this->email->subject('Cửa hàng Fashion_Shop');
        ...
        $this->data['title']='Fashion_Shop - Kết quả đơn hàng';
        $this->data['view']='Cảm ơn bạn';
        $this->load->view('frontend/layout',$this->data);
    }
